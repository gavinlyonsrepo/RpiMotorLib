...
Class  : A4988Nema
Tested : LV8729 Nema stepper motor
...
def main():
    ...
    time.sleep(1)
    input("TEST: Press <Enter> to continue timedelay Test 3")
    mymotortest.motor_go(True, "Full", 10, 1, True, .05)
    time.sleep(1)

    # === Section B ===
    print("TEST SECTION B")
    input("TEST: Press <Enter> to continue Half Test 4")
    mymotortest.motor_go(False, "Half", 400, .005, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue 1/4 Test 5")
    mymotortest.motor_go(False, "1/4", 800, .005, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue 1/8 Test 6")
    mymotortest.motor_go(False, "1/8", 1600, .005, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue 1/16 Test 7")
    mymotortest.motor_go(False, "1/16", 3200, .005, True, .05)
    time.sleep(1)

    # === Section C ===
    print("TEST SECTION C")
    input("TEST: Press <Enter> to continue 1/32 Test 8")
    mymotortest.motor_go(False, "1/32", 6400, .005, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue 1/64 Test 9")
    mymotortest.motor_go(False, "1/64", 12800, .005, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue 1/128 Test 10")
